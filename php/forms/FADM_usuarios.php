<div class="fix-margin">
	...
	<form class="formulario" method="POST" action="../includes/functions_admin.php" autocomplete="off">
		...
		<div class="campo__3--button">
			...
			<input class="campo__field button--blue" name="U_Rol" type="submit" value="Actualizar Rol">
		</div>
	</form>
	<form method="POST" action="../php/ADM_usuarios.php" style="overflow: hidden">
		<div class="consultas">
			<input class="campo__field consultas--button button--blue" type="submit" value="Consultar todo" name="ADM_usuarios">
		</div>
	</form>
</div>