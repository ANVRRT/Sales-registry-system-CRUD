<div class="fix-margin">
	<form method="POST" action="../php/O_capturarArchivo.php" style="overflow: hidden" enctype="multipart/form-data">
		<div class="campo__icon">
			<h1 class="h1-mine campo__label--icon">Capturar Archivo</h1>
			<div class="upload">
				<label for="uploadFile">
					<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-plus upload--icon" width="48" height="48" viewBox="0 0 24 24" stroke-width="2" stroke="#36b9cc" fill="none" stroke-linecap="round" stroke-linejoin="round">
				...
				<input type="submit" name="submitFile" style="display:none" id="submitFl">
				<input class="campo__field" type="file" name="uploadFile" id="uploadFile" onchange="document.getElementById('submitFl').click()">
			</div>
		</div>
	</form>
